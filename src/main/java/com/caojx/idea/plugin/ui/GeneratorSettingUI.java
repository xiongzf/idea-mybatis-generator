...
public class GeneratorSettingUI extends DialogWrapper {
    ...
    private void renderUIData(Project project) {
        ...
        controllerNamePrefixTf.setText(controllerProperties.getNamePrefix());
    }
    ...
    private void restUIData() {
        ...
        controllerNamePrefixTf.setText("");
    }
...
//            resetPackageAndPathTableData();
        ...
        queryTableBtn.addActionListener(e -> {
            try {
                ...
                MyMessages.showWarningDialog(project, "数据库连接错误，请检查数据库配置.", "Warning");
            }
        });
        ...
        generatorBtn.addActionListener(e -> {
            ...
            generatorContext.setTablePrefix(selectedDatabase.getTablePrefix());
    ...
    private GeneratorProperties getGeneratorProperties() {
        ...
        controllerProperties.setNamePrefix(StringUtils.trim(controllerNamePrefixTf.getText()));
...
//            }
    ...
    private void initDatabaseComBox(List<DatabaseWithOutPwd> databases, String selectedShowDatabaseName) {
        ...
        tableNamePrefixTf.setText(selectedDatabase.getTablePrefix());
    }
